package com.crossBrowserTesting.utilities;
...
public class Utils {
	...
	public Properties init_prop()
	{
		prop = new Properties();
		try {
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir") + "/src/test/java/com/crossBrowserTesting/config.properties");
			//C:\Amruta_Dawande\VisionIT\javacodes\SeleniumBasics\src\test\java\com\crossBrowserTesting
			prop.load(ip);
